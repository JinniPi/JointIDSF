...
MODEL_CLASSES = {
    "xlmr": (XLMRobertaConfig, JointIDSF, XLMRobertaTokenizer),
    "phobert": (RobertaConfig, JointIDSF, AutoTokenizer),
    "atisbert": (RobertaConfig, JointIDSF, AutoTokenizer)
}
